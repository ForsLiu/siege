// Pure screen state machine: Title -> Run -> Results -> Title, plus the Dev fight screen.
// Illegal events return the input state unchanged (same reference).

export type Screen = 'title' | 'run' | 'results' | 'devFight';
...
export const SCREEN_EVENT_TYPES: readonly ScreenEvent['type'][] = ['startRun', 'startDevFight', 'runEnded', 'togglePause', 'resume', 'toTitle'];
