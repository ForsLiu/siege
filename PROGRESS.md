...
## Next action
Continue BACKLOG.md P0 in the owner's verdict order: **P0-09 (UI shell hardening)** next, then P0-17/P0-18 (battle sandbox), P0-19/P0-20 (unit inspector), P0-21…P0-24 (run HUD, augments). P0-B4, P0-B5, P0-B6 and P0-B7 stay deferred to the end of P0.
...
- `Escape` is handled before the text-input guard in `main.ts`, so pressing it while typing a seed or a dev-panel id toggles pause (pre-existing; P0-09 owns input handling).
