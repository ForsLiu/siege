...
## Next action
Continue BACKLOG.md P0 in the owner's verdict order: **P0-16 (dev panel, F2)** next, then P0-09 (UI shell hardening), P0-17/P0-18 (battle sandbox), P0-19/P0-20 (unit inspector). P0-B4, P0-B5, P0-B6 and the new P0-B7 stay deferred to the end of P0.
