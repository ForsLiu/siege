...
## Next action
Continue BACKLOG.md P0 in the owner's verdict order: **P0-17 (battle sandbox core)** next, then P0-18 (sandbox screen), P0-19/P0-20 (unit inspector), P0-21…P0-24 (run HUD, round track, shop HUD, augments). P0-B4, P0-B5, P0-B6 and P0-B7 stay deferred to the end of P0.
