...
## Next action
Continue BACKLOG.md P0 in the owner's verdict order: **P0-22 (round track)** next, then P0-23…P0-24 (shop HUD, augments). P0-B4…P0-B15 stay deferred/queued per the triage rule (P0-B11/P0-B12 are money-path bugs QA filed on P0-20, ranked above the rest of section 3 but still below the remaining owner-request items; P0-B13/14/15 are P0-21 polish deferrals).

## Pipeline checks
- `npm run check` — green (tsc + architecture test, 99 tests).
- `npm run test:fast` — green, 354 tests + 1 documented skip in 24 files; measured wall time **~3.5 s** (limit 5 min).
