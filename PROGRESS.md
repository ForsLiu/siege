...
## Next action
Continue BACKLOG.md P0 in the owner's verdict order: **P0-20 (inspector panel & board readability)** next, then P0-21…P0-24 (run HUD, round track, shop HUD, augments). P0-B4…P0-B10 stay deferred to the end of P0.
